...
//               className='w-40 mr-4 cursor-pointer mx-24 sm:mx-10'
//               />
//           ))}
//         </div>
//       </div>
...
//             <h2 className='text-4xl font-bold mb-2 sm:text-xl text-white text-center' >Game Rules:</h2>
    ...
    <div className='flex flex-col items-center'>
      ...
      <div className='mt-4 flex justify-center'>
        <div className='w-full sm:w-auto'>
          <div className='bg-gray-800 opacity-90 p-4 rounded-lg mt-4'>
            <h2 className='lg:text-4xl sm:text-xl font-bold mb-2 text-white text-center'>Game Rules:</h2>
            <ul className='list-none ml-4 text-white text-4xl sm:text-3xl'>
              <li>MasterShell &gt; Lightning</li>
              <li>BananaPeel &gt; MasterShell</li>
              <li>Lightning &gt; BananaPeel</li>
            </ul>
      ...
      <div className='mt-4 flex justify-center'>
        <button
          onClick={resetScores}
          className='bg-gray-700 hover:bg-gray-500 opacity-90 text-white text-3xl sm:text-xl font-bold py-2 px-4 rounded mr-4 relative z-10'>
          Reset Scores
        </button>
        <Link
          to='/'
          className='bg-gray-700 hover:bg-gray-500 text-white text-3xl sm:text-xl font-bold py-2 px-4 rounded mr-4 relative z-10'>
          Back to Main
        </Link>
      </div>
    </div>
