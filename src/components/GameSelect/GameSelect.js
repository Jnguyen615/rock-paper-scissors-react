  ...
  return (
    <main className='flex flex-col items-center justify-center'>
      ...
      <div className='text-center'>
        <h1 className='text-white text-3xl md:text-5xl lg:text-7xl relative z-10 mb-20 font-workbench mt-20'>
          Choose your game mode
        </h1>
        <Link
          to='/easy'
          className='classic-mode-button relative z-10 mb-4 md:mb-8'>
